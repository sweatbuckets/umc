...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -1773384487L;
    ...
    public final umc.spring.workbook5.domain.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.spring.workbook5.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
