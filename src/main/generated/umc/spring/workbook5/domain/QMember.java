...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = -306324205L;
    ...
    public final EnumPath<umc.spring.workbook5.domain.enums.Gender> gender = createEnum("gender", umc.spring.workbook5.domain.enums.Gender.class);
    ...
    public final ListPath<umc.spring.workbook5.domain.mapping.MemberMission, umc.spring.workbook5.domain.mapping.QMemberMission> memberMissionList = this.<umc.spring.workbook5.domain.mapping.MemberMission, umc.spring.workbook5.domain.mapping.QMemberMission>createList("memberMissionList", umc.spring.workbook5.domain.mapping.MemberMission.class, umc.spring.workbook5.domain.mapping.QMemberMission.class, PathInits.DIRECT2);
    ...
    public final EnumPath<umc.spring.workbook5.domain.enums.SocialType> socialType = createEnum("socialType", umc.spring.workbook5.domain.enums.SocialType.class);

    public final StringPath specAddress = createString("specAddress");

    public final EnumPath<umc.spring.workbook5.domain.enums.MemberStatus> status = createEnum("status", umc.spring.workbook5.domain.enums.MemberStatus.class);
